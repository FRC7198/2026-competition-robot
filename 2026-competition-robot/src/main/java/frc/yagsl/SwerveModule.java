...
import frc.yagsl.parser.SwerveModuleConfiguration;
import frc.yagsl.parser.SwerveModulePhysicalCharacteristics;
import frc.yagsl.simulation.SwerveModuleSimulation;
...
public class SwerveModule implements AutoCloseable
{
   ...
   * {@link frc.yagsl.simulation.ironmaple.simulation.drivesims.SwerveModuleSimulation}
   *
   * @param swerveModuleSimulation  MapleSim {@link frc.yagsl.simulation.ironmaple.simulation.drivesims.SwerveModuleSimulation} to
   *                                configure with.
  ...
  public void configureModuleSimulation(
      frc.yagsl.simulation.ironmaple.simulation.drivesims.SwerveModuleSimulation swerveModuleSimulation,
