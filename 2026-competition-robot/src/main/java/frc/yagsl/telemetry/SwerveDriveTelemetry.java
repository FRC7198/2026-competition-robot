...
/**
 * Telemetry to describe the {@link frc.yagsl.SwerveDrive} following frc-web-components. (Which follows AdvantageKit)
 */
public class SwerveDriveTelemetry
{
   ...
   * {@link frc.yagsl.SwerveModule#setDesiredState(SwerveModuleState, boolean, double)} is called for the last module.
   */
