package frc.yagsl.simulation.ironmaple.simulation.drivesims;

import edu.wpi.first.math.geometry.Rotation2d;
import edu.wpi.first.units.measure.AngularVelocity;
import edu.wpi.first.units.measure.Time;
import frc.yagsl.simulation.ironmaple.simulation.SimulatedArena;
import frc.yagsl.simulation.ironmaple.utils.mathutils.MapleCommonMath;
...
public class GyroSimulation {
     ...
     *
     * <p>If you are using this class outside of {@link frc.yagsl.simulation.ironmaple.simulation.SimulatedArena}: make sure to call it 5
     * times in each robot period (if using default timings), or refer to
     * {@link frc.yagsl.simulation.ironmaple.simulation.SimulatedArena#overrideSimulationTimings(Time, int)}.
     *
