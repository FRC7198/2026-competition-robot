package frc.yagsl.simulation.ironmaple.simulation.opponentsim;
...
import frc.yagsl.simulation.ironmaple.simulation.opponentsim.pathfinding.MapleADStar;
import frc.yagsl.simulation.ironmaple.utils.FieldMirroringUtils;
...
public abstract class SmartOpponent extends SubsystemBase {
    ...
    public SmartOpponent(SmartOpponentConfig config) {
        ...
        /// Adds the required states to run the {@link frc.yagsl.simulation.ironmaple.simulation.opponentsim.SmartOpponent}.
