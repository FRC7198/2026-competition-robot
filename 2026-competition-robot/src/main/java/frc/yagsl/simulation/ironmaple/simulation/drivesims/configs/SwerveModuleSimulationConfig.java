package frc.yagsl.simulation.ironmaple.simulation.drivesims.configs;

import edu.wpi.first.math.system.plant.DCMotor;
import edu.wpi.first.math.util.Units;
import edu.wpi.first.units.measure.*;
import frc.yagsl.simulation.ironmaple.simulation.SimulatedArena;
import frc.yagsl.simulation.ironmaple.simulation.drivesims.SwerveModuleSimulation;
import frc.yagsl.simulation.ironmaple.simulation.motorsims.SimMotorConfigs;
