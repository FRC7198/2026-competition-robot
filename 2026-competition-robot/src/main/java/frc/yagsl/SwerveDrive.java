...
import frc.yagsl.simulation.ironmaple.simulation.SimulatedArena;
import frc.yagsl.simulation.ironmaple.simulation.drivesims.AbstractDriveTrainSimulation;
import frc.yagsl.simulation.ironmaple.simulation.drivesims.SwerveDriveSimulation;
import frc.yagsl.simulation.ironmaple.simulation.drivesims.configs.DriveTrainSimulationConfig;
import frc.yagsl.simulation.ironmaple.simulation.drivesims.configs.SwerveModuleSimulationConfig;
import frc.yagsl.imu.SwerveIMU;
import frc.yagsl.math.SwerveMath;
import frc.yagsl.parser.Cache;
import frc.yagsl.parser.SwerveControllerConfiguration;
import frc.yagsl.parser.SwerveDriveConfiguration;
import frc.yagsl.simulation.SwerveIMUSimulation;
...
//    resetOdometry(newOdometry);
  ...
  /**
   * Enable or disable the {@link frc.yagsl.parser.SwerveModuleConfiguration#useCosineCompensator} for all
