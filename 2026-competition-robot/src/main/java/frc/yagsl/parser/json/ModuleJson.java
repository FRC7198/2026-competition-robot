...
import frc.yagsl.encoders.ThriftyNovaEncoderSwerve;
...
import frc.yagsl.parser.json.modules.BoolMotorJson;
import frc.yagsl.parser.json.modules.ConversionFactorsJson;
import frc.yagsl.parser.json.modules.LocationJson;

/**
 * {@link frc.yagsl.SwerveModule} JSON parsed class. Used to access the JSON data.
 */
