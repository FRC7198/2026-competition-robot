...
public class SwerveModulePhysicalCharacteristics
{
   ...
   * {@link frc.yagsl.math.SwerveMath#calculateMetersPerRotation(double, double, double)} and
   * {@link frc.yagsl.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)}.
   */
   ...
   *                                       {@link frc.yagsl.math.SwerveMath#calculateMetersPerRotation(double, double,
   *                                       double)} and
   *                                       {@link frc.yagsl.math.SwerveMath#calculateDegreesPerSteeringRotation(double,
   *                                       double)}.
