...
import frc.yagsl.SwerveModule;
import frc.yagsl.math.SwerveMath;
import frc.yagsl.parser.json.ControllerPropertiesJson;
import frc.yagsl.parser.json.ModuleJson;
import frc.yagsl.parser.json.PIDFPropertiesJson;
import frc.yagsl.parser.json.PhysicalPropertiesJson;
import frc.yagsl.parser.json.SwerveDriveJson;
...
public class SwerveParser
{
   ...
   *                 {@link frc.yagsl.SwerveController} and drive feedforward in
   ...
   *                                   acceleration used in {@link frc.yagsl.SwerveController} and drive feedforward in
   *                                   {@link SwerveMath#createDriveFeedforward(double, double, double)}.
   ...
   *                    {@link frc.yagsl.SwerveController} of the robot
