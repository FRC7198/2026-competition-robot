...
/**
 * Swerve Module configuration class which is used to configure {@link frc.yagsl.SwerveModule}.
 */
public class SwerveModuleConfiguration
{
   ...
   * {@link frc.yagsl.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)} respectively to calculate the
   * conversion factors.
   */
