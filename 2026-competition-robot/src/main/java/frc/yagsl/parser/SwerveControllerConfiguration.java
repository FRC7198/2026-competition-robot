...
import static frc.yagsl.math.SwerveMath.calculateMaxAngularVelocity;

/**
 * Swerve Controller configuration class which is used to configure {@link frc.yagsl.SwerveController}.
 */
